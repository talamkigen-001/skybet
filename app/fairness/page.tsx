...
function FairnessForm() {
  const searchParams = useSearchParams();
  const queryNonce = searchParams.get("nonce") ? Number(searchParams.get("nonce")) : undefined;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-8">
        ...
        <Suspense fallback={<div className="text-muted-foreground text-sm">Loading fairness parameters…</div>}>
          <FairnessForm />
        </Suspense>
      </main>
    </div>
