...
export const Route = createFileRoute("/games/live/")({
  head: () => ({
    meta: [
      { title: "Live Casino — 1win" },
      {
        name: "description",
        content:
          "Play the best 1win Live Casino games: Lucky Jet, Speed & Cash, Rocket Queen, Aviator, JetX, Mines, Plinko, Crazy Time, and Live Roulette.",
      },
    ],
  }),
  component: LiveCasinoLobby,
});

function LiveCasinoLobby() {
